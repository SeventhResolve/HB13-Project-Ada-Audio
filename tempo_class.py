...
class Tempo(object):
    ...
    def creates_tempo_en_playlist(self):
        ...
        en_playlist = playlist.static(session_id=en_session_id_and_en_song_id[0],
                                 song_id=en_session_id_and_en_song_id[1])
        # wrong parameters! check pyechonext for the correct parameters
